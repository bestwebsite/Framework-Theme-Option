...
class Options_Framework_Admin {
	...
	function enqueue_admin_styles() {
		wp_enqueue_style( 'optionsframework', bestwebsite_OPTIONS_FRAMEWORK_DIRECTORY . 'css/optionsframework.css', array(), Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'options-custom', bestwebsite_OPTIONS_FRAMEWORK_DIRECTORY . 'js/options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION );
